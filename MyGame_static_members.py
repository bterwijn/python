...
class Alien:
    ...
    speed = 0
    radius = 6
    color = pygame.colordict.THECOLORS['red']
    ...
    def move(self):
        ...
        self.position.y += Alien.speed + self.speed + speed
